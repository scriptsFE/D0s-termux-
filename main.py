...
USER_AGENTS = [
    ...
    "Mozilla/5.0 (Linux; Android 13; Redmi Note 11) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Mobile Safari/537.36",
    
    "Mozilla/5.5 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/119.0",
    ...
    "Mozilla/5.0 (iPhone; CPU iPhone OS 17_1_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.1 Mobile/15E148 Safari/605.1.15",
    ...
    "Mozilla/5.0 (iPad; CPU OS 17_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.1 Mobile/15E148 Safari/605.1.15",
    "Mozilla/5.0 (iPad; CPU OS 17_2_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.2 Mobile/15E148 Safari/605.1.15",
    ...
    "Mozilla/5.0 (Linux; Android 10; HD1913) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Mobile Safari/537.36 EdgA/121.0.0.0",
    "Mozilla/5.0 (iPhone; CPU iPhone OS 17_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 EdgiOS/121.0.0.0 Mobile/15E148 Safari/605.1.15",
    ...
    "Mozilla/5.0 (Linux; Android 13; OPR9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Mobile Safari/537.36 OPR/79.0.0.0",
...
async def stats_reporter():
    ...
    try:
        while True:
            ...
            sys.stdout.write(
                f"\r[Stats] Success: {stats['success']} | Errors: {stats['errors']} | "
                f"Total {stats['total']} | Speed {req_per_sec:.2f} req/s"
            )
            sys.stdout.flush()
...
async def main():
    ...
    if not target_url:
        print("[!] Target url cannot be empity duh")
        sys.exit(1)
    ...
    try:
        concurrency_limit = int(input("Max ammount send").strip())
    except ValueError:
        print("[!] Concurrency limit must be a integer")
        sys.exit(1)

    print(f"\n[!] Initializing async engine with a concurrency limit of {concurrency_limit}...")
