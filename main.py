...
# Exactly 100 modern, realistic User-Agent strings
USER_AGENTS = [
    ...
    # --- CHROME & SAFARI VARIATIONS (Additional Releases) ---
...
async def main():
    print("=" * 45)
    print("      ASYNC WEB PERFORMANCE TESTER (TERMUX)     ")
    print("=" * 45)
    ...
    try:
        concurrency_limit = int(input("Max concurrent connections (e.g., 50): ").strip())
    except ValueError:
        print("[!] Concurrency limit must be an integer.")
        sys.exit(1)
